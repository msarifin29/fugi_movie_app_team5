...
LatestMovie _$LatestMovieFromJson(Map<String, dynamic> json) {
  return _LatestMovie.fromJson(json);
}
...
mixin _$LatestMovie {
  ...
  @JsonKey(ignore: true)
  $LatestMovieCopyWith<LatestMovie> get copyWith =>
...
/// @nodoc
abstract class _$$_LatestMovieCopyWith<$Res>
    implements $LatestMovieCopyWith<$Res> {
  factory _$$_LatestMovieCopyWith(
...
/// @nodoc
@JsonSerializable()
class _$_LatestMovie implements _LatestMovie {
  const _$_LatestMovie(
      {required this.adult,
      @JsonKey(name: 'backdrop_path')
          this.backdropPath,
      @JsonKey(name: 'belong_to_collection')
  ...
  factory _$_LatestMovie.fromJson(Map<String, dynamic> json) =>
      _$$_LatestMovieFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$_LatestMovieToJson(
      this,
    );
  }
}

abstract class _LatestMovie implements LatestMovie {
  const factory _LatestMovie(
  ...
  factory _LatestMovie.fromJson(Map<String, dynamic> json) =
      _$_LatestMovie.fromJson;
