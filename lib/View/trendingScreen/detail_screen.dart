...
import 'package:fugi_movie_app_team5/Controller/riverpod/latest_movie.dart';
...
class LatestMovies extends ConsumerWidget {
  const LatestMovies({
    Key? key,
  }) : super(key: key);
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final dataLatest = ref.watch(latestProvider);
    return dataLatest.when(
        data: (data) {
          bool adult = true;
          return Padding(
            padding: const EdgeInsets.symmetric(horizontal: 10),
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: Theme.of(context).textTheme.bodySmall!.copyWith(
                          fontWeight: FontWeight.bold, wordSpacing: 1),
                      textAlign: TextAlign.justify,
                    ),
                  ],
                ),
